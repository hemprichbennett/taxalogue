...
yes | bundle exec ruby taxalogue.rb --taxon Arthropoda classify --gbol --bold_release downloads/BOLD_Public.01-Jan-2024.tsv --genbank_dir downloads/NCBIGENBANK/release259 --taxon_rank family
